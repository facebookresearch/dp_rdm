...
from rdm.util import aggregate_and_noise
        ...
        if conditioning is not None:
            ...
            if isinstance(conditioning, list):
                for c in conditioning:
                    ...
                    print(f"Warning: Got {c} conditionings but batch-size is {batch_size}")
            else:
...
class DDIMRetroSampler(DDIMSampler):
    ...
    def ddim_sampling(self, cond, retro_cond, shape, r_shape=None,
        ...
        r_enc = aggregate_and_noise(self.aggregate, r_enc, self.k_nn, self.k_nn_max_noise)
